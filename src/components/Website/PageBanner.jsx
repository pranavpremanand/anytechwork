...
const PageBanner = ({ title }) => {
  return (
    <div className="min-h-[40vh] md:min-h-[70vh] w-full page-banner relative">
      <div className="absolute top-0 left-0 w-full h-full bg-black/40 z-10"></div>
      <ReactPlayer url={vid} playing loop muted width="100%" height="100%" />
      <div className="absolute z-20 py-3 top-1/2 left-1/2 -translate-x-1/2 w-full flex flex-col items-center px-3">
