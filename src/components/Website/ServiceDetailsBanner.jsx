...
const ServiceDetailsBanner = () => {
  ...
  return (
    <div className="min-h-[40vh] md:min-h-[70vh] w-full page-banner relative bg-[#17012C]">
      <div className="absolute py-3 top-1/2 left-1/2 -translate-x-1/2 w-full flex flex-col items-center px-3">
